...
export default function ControlLayout() {
  ...
  const renderContent = () => {
    switch (tab) {
      case "play":
        return <Text style={styles.tabContent}>🎶 Play Mode</Text>;
      case "editing":
        return <Text style={styles.tabContent}>📝 Editing Mode</Text>;
      case "score":
        return <Text style={styles.tabContent}>📄 Score View</Text>;
      case "chord":
      default:
        return <Text style={styles.tabContent}>🎸 Chord View</Text>;
    }
  };
