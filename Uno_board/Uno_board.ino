...
const uint8_t FINGER_START_PINS[] = {38, 36, 37, 39};

Slider sliders[4] = {
    Slider(SLIDER_START_PINS[1], SLIDER_DIR_PINS[1], SLIDER_SPEED_PINS[1], SLIDER_SENSOR_PIN[1], 2, sliderConfigs[0]),
    Slider(SLIDER_START_PINS[0], SLIDER_DIR_PINS[0], SLIDER_SPEED_PINS[0], SLIDER_SENSOR_PIN[0], 1, sliderConfigs[1]),
...
RackMotor rackMotors[4] = {
    RackMotor(RACK_START_PINS[1], RACK_DIR_PINS[1], RACK_SPEED_PINS[1], RACK_SENSOR_PIN[1], 6, rackConfigs[0]),
    RackMotor(RACK_START_PINS[0], RACK_DIR_PINS[0], RACK_SPEED_PINS[0], RACK_SENSOR_PIN[0], 5, rackConfigs[1]),
